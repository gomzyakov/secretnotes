...
namespace App\Services\LaravelLocalization;

use App\Services\LaravelLocalization\Exceptions\SupportedLocalesNotDefined;
use App\Services\LaravelLocalization\Exceptions\UnsupportedLocaleException;
...
class LaravelLocalization
{
     ...
     * @param bool|string $locale Locale to adapt, false to remove locale
     *
     * @throws UnsupportedLocaleException
     *
     ...
     *
     * @param bool|string  $locale               Locale to adapt, false to remove locale
     * @param false|string $url                  URL to adapt in the current language. If not passed, the current url would be taken.
     ...
     * @throws UnsupportedLocaleException
     *
     * @return false|string URL translated, False if url does not exist
     */
     ...
     *
     * @param bool|string $locale               Locale to adapt
     ...
     *
     * @param false|string $url URL to clean, if false, current url would be taken
     *
     ...
     *
     * @return false|string Key for translation, false if not exist
     */
     ...
     *
     * @param false|string|null $url        Url to check if it is a translated route
     ...
     *
     * @param bool|false|string|null $url    to extract attributes, if not present, the system will look for attributes in the current call
     * @param string                 $locale
     *
